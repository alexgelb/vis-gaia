...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\textwidth]{VelocityDist.jpg}
	\caption{Line graph}
	\label{fig7}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\textwidth]{DistanceTime.jpg}
	\caption{Dot plot}
	\label{fig8}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\textwidth]{CorrelationParallax.jpg}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\textwidth]{Boxplot.jpg}
	\caption{Boxplot }
	\label{fig10}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\textwidth]{VelocityError.jpg}
	\caption{Linegraph  }
	\label{fig11}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\textwidth]{ClustersWeight.jpg}
	\caption{Bargraph  }
	\label{fig12}
\end{figure}
\end{itemize}
